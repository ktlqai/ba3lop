...
CREATE TABLE `user` (
  ...
  `list_sodienthoai` varchar(200) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `user` (`id`, `name`, `email`, `phone`, `address`, `password`, `created`, `ID_CMND`, `address_giaohang`, `dob`, `list_sodienthoai`) VALUES
