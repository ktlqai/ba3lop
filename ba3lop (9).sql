...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 06, 2016 at 04:17 AM
...
(8, 'adminphucuong', '5b5ff07b580b4c4c6c7df120ffc66ac2', 'Phú Cường', 0);
...
INSERT INTO `dathang` (`id`, `user_id`, `notkeyword_date`, `user_refer_id`, `created`) VALUES
(1, 22, '2016-11-02', 22, 1478229114),
(2, 22, '2016-11-05', 22, 1478350822);

-- --------------------------------------------------------

--
-- Table structure for table `dathang_dong`
--

CREATE TABLE `dathang_dong` (
  `id` int(255) NOT NULL,
  `dathang_id` int(255) NOT NULL,
  `tensanpham` varchar(500) CHARACTER SET latin1 NOT NULL,
  `giadonvi` decimal(10,0) NOT NULL,
  `soluong` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `dathang_dong`
--

INSERT INTO `dathang_dong` (`id`, `dathang_id`, `tensanpham`, `giadonvi`, `soluong`) VALUES
(1, 1, 'kem', '15000', 4),
(2, 1, 'ph?n', '4000', 7),
(3, 2, 'son môi', '50000', 5),
(4, 2, 'kem m?t', '15000', 2);
...
CREATE TABLE `user` (
  ...
  `created` int(11) NOT NULL,
  `ID_CMND` varchar(25) COLLATE utf8_unicode_ci NOT NULL,
  `address_giaohang` varchar(500) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `user` (`id`, `name`, `email`, `phone`, `address`, `password`, `created`, `ID_CMND`, `address_giaohang`, `dob`) VALUES
(19, 'Hoàng văn Tuyền', 'hoangvantuyencnt@gmail.com', '1245454545', 'hải Phòng', '96e79218965eb72c92a549dd5a330112', 0, '', '', ''),
(21, 'Lê Quý Ái', 'ktlqai@gmail.com', '01662222616', 'duong 30, binh phu', '96e79218965eb72c92a549dd5a330112', 0, '', '', ''),
(22, 'Nguyễn Văn User', 'co@gmail.com', '0938784013', 'dc cua user', '96e79218965eb72c92a549dd5a330112', 0, '', '', '');
...
INSERT INTO `user_refer` (`id`, `name`, `email`, `phone`, `address`, `password`, `created`, `ID_CMND`, `dob`) VALUES
(19, 'Hoàng văn Tuyền', 'hoangvantuyencnt@gmail.com', '1245454545', 'hải Phòng', '96e79218965eb72c92a549dd5a330112', 0, '', ''),
(21, 'Lê Quý Ái', 'ktlqai@gmail.com', '01662222616', 'duong 30, binh phu', '96e79218965eb72c92a549dd5a330112', 0, '', ''),
(22, 'Tô Vĩnh Hậu', 'anhhau@gmail.com', '0938784013', 'dc cua cò', '96e79218965eb72c92a549dd5a330112', 0, '', '');
...
--
-- Indexes for table `dathang_dong`
--
ALTER TABLE `dathang_dong`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `dathang_dong`
--
ALTER TABLE `dathang_dong`
